...
if (!sessionStorage.getItem("dogBreed")) {
    var dogBreed_1 = (prompt("Quick question! What's your favorite dog breed? "));
    if (dogBreed_1) {
        sessionStorage.setItem("dogBreed", dogBreed_1);
    }
}
var dogBreed = sessionStorage.getItem("dogBreed") || "all type";
// 2/24/25 removed for simplicity ---> alert (dogBreed +"! Gotcha!!");
var listElement = document.getElementById("list");
if (listElement) {
    listElement.innerText = "Have you felt like your partys are a little lack-luster lately?" +
